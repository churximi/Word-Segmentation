...
threads_num = " --threads " + str(5)  # 更改线程数
last_stage = " --last-stage " + "srl"  # 最终步骤，可设置ws、pos、ner、dp、srl、all
input_path = " --input " + r"D:\BookReviews\WordSegmentor\file\input.txt"  # 输入文件
seg_lexicon = r"D:\BookReviews\WordSegmentor\file\seg_lexicon.txt"   # 分词用户词典
pos_lexicon = r"D:\BookReviews\WordSegmentor\file\pos_lexicon.txt"   # 词性标注用户词典
output_path = r"D:\BookReviews\WordSegmentor\file\out2.txt"  # 输出文件
